...
export const projects = [
  {
    id: 1,
    title: "STTFFD - BASELINE CORROSION SURVEY FOR JACKET/DECK LEG",
    client: "Vietnam Japan Gas Plant / PTSC",
    industry: "Oil & Gas",
    description:
  ...
  {
    id: 3,
    title: "PAUT SERVICE FOR LPG TANKS – DINH VU PROJECT",
  ...
  {
    id: 6,
    title: "NDT FOR DINH CO GPP COLUMN C-01",
    client: "PV GAS",
    industry: "Oil & Gas",
    description:
