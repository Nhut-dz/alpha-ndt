...
export default function Services() {
  ...
  return (
    <section id="services" className="py-24 bg-blue-950" ref={sectionRef}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {filtered.map((service, i) => (
            <div
              ...
              className={`group relative bg-blue-800 border border-slate-700 rounded-2xl p-6 cursor-pointer
