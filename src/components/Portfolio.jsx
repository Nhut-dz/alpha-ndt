...
export default function Portfolio() {
  ...
  return (
    <section id="portfolio" className="py-12 bg-slate-50" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filters.map((f) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-full text-sm font-semibold transition-all duration-200 ${
                activeFilter === f
                  ? "bg-blue-600 text-slate-800 shadow-lg shadow-blue-500/25"
        ...
        {totalPages > 1 && (
          <div className={`flex justify-center items-center gap-2 mt-10 transition-all duration-700 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            <button
              ...
              className="w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-200 bg-slate-100 text-slate-600 hover:bg-slate-200 hover:text-slate-800 disabled:opacity-40 disabled:cursor-not-allowed"
            >
              ‹
            </button>
        ...
        <div className={`text-center mt-10 transition-all duration-700 delay-400 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
          <button className="inline-flex items-center gap-2 border border-slate-200 hover:border-blue-500 text-slate-700 hover:text-slate-800 font-semibold px-8 py-3.5 rounded-xl transition-all duration-200 hover:bg-slate-200">
