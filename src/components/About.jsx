          ...
          <div className="border-t border-slate-800 pt-16">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-6 gap-4 mb-10">
              {certifications.map((cert) => (
                <div
                  key={cert.code}
                  className="bg-slate-800 hover:bg-slate-700 border border-slate-700 hover:border-blue-500/50 rounded-xl p-4 text-center transition-all duration-200 group"
                >
            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {classifications.map((cls) => (
                  <span
                    key={cls}
                    className="bg-slate-800 border border-slate-700 text-slate-300 text-sm font-semibold px-4 py-2 rounded-full hover:border-blue-500/50 hover:text-blue-400 transition-colors"
                  >
                    {cls}
                  </span>
                ))}
