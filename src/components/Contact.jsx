...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-12 bg-white dark:bg-slate-900" ref={ref}>
                ...
                <div key={i} className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    {info.href ? (
                      <a
                        href={info.href}
                        className="text-slate-700 dark:text-slate-300 text-sm hover:text-blue-400 transition-colors whitespace-pre-line"
                      >
                        {info.value}
                      </a>
                    ) : (
                      <p className="text-slate-700 dark:text-slate-300 text-sm whitespace-pre-line">{info.value}</p>
                    )}
                  </div>
                </div>
              ))}
            ...
            <div className="bg-slate-50 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 sm:p-8">
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="text-slate-800 dark:text-white font-black text-2xl mb-2">Gửi thành công!</h3>
                ...
                <form onSubmit={handleSubmit} noValidate className="space-y-5">
                  <h3 className="text-slate-800 dark:text-white font-bold text-xl mb-6">{t(lang, "contact.send")}</h3>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full bg-white dark:bg-slate-900 border rounded-xl px-4 py-3 text-slate-800 dark:text-white text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-colors ${errors.name ? "border-red-500/50" : "border-slate-300 dark:border-slate-600 focus:border-blue-500"}`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full bg-white dark:bg-slate-900 border rounded-xl px-4 py-3 text-slate-800 dark:text-white text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-colors ${errors.email ? "border-red-500/50" : "border-slate-300 dark:border-slate-600 focus:border-blue-500"}`}
                      />
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-slate-500 dark:text-slate-400 text-sm font-medium mb-2">{t(lang, "contact.phone")}</label>
                      <input
                        type="tel"
                        value={formData.phone}
                        onChange={handleChange("phone")}
                        placeholder="+84 9xx xxx xxx"
                        className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 focus:border-blue-500 rounded-xl px-4 py-3 text-slate-800 dark:text-white text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block text-slate-500 dark:text-slate-400 text-sm font-medium mb-2">{t(lang, "contact.service")}</label>
                      <select
                        value={formData.service}
                        onChange={handleChange("service")}
                        className="w-full bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 focus:border-blue-500 rounded-xl px-4 py-3 text-slate-800 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-colors appearance-none"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className={`w-full bg-white dark:bg-slate-900 border rounded-xl px-4 py-3 text-slate-800 dark:text-white text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-colors resize-none ${errors.message ? "border-red-500/50" : "border-slate-300 dark:border-slate-600 focus:border-blue-500"}`}
                    />
