...
export default function Partners() {
  ...
  return (
    <section id="partners" className="py-20 bg-blue-900 overflow-hidden" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`relative transition-all duration-700 delay-200 ${visible ? "opacity-100" : "opacity-0"}`}>
          {/* Fade masks */}
          <div className="absolute left-0 top-0 bottom-0 w-24 z-10 bg-gradient-to-r from-blue-900 to-transparent pointer-events-none" />
          <div className="absolute right-0 top-0 bottom-0 w-24 z-10 bg-gradient-to-l from-blue-900 to-transparent pointer-events-none" />
          ...
          <div className="flex gap-4 overflow-hidden">
            ...
            >
              {doubled.map((partner, i) => (
                <div
                  key={i}
                  className="flex-none flex items-center justify-center w-40 h-20 bg-blue-800 border border-slate-700 rounded-xl hover:border-blue-500/50 hover:bg-blue-800 transition-all duration-200 group"
                >
        ...
        <div className={`mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 transition-all duration-700 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          {[
            ...
            <div
              key={i}
              className="bg-blue-800 border border-slate-700 rounded-2xl p-6 text-center hover:border-blue-500/30 transition-colors"
            >
