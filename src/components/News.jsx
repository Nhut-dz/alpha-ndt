...
const defaultCategoryColors = "bg-slate-500/10 text-slate-600 dark:text-slate-300 border-slate-500/20";
...
export default function News() {
  ...
  return (
    <section id="news" className="pt-6 pb-12 bg-slate-50 dark:bg-slate-800" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 gap-4 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          ...
          <a
            href="#"
            className="flex-none inline-flex items-center gap-2 border border-slate-300 dark:border-slate-600 hover:border-blue-500 text-slate-600 hover:text-slate-800 dark:text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-all duration-200"
          >
            Xem tất cả
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-slate-800 dark:text-white font-bold text-base leading-snug mb-3 group-hover:text-blue-600 transition-colors line-clamp-2">
                      {article.title}
                    </h3>
