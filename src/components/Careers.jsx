...
export default function Careers() {
  ...
  return (
    <section id="careers" className="py-24 bg-blue-900" ref={ref}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-4 transition-all duration-700 delay-100 ${visible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}>
            ...
            {jobOpenings.map((job, i) => (
              <div
                key={job.id}
                className="group flex items-start gap-4 bg-blue-800 border border-slate-700 rounded-xl p-5 hover:border-blue-500/50 hover:bg-slate-750 transition-all duration-200 cursor-pointer hover:-translate-y-0.5"
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-2 text-xs">
                    ...
                    <span className="bg-orange-500/10 text-orange-400 border border-orange-500/20 px-2 py-0.5 rounded-full font-medium">
                      {job.type}
                    </span>
                  </div>
                </div>
          ...
          <div className={`transition-all duration-700 delay-200 ${visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}>
            <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-blue-900 to-blue-950 border border-slate-700 p-8">
              {/* Decoration */}
              ...
              <div className="relative z-10">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-7 py-3.5 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-orange-500/25"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
