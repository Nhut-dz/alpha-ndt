        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {certBadges.map((cert) => (
                <span key={cert} className="bg-slate-800 border border-slate-700 text-slate-400 text-xs px-2.5 py-1 rounded-lg">
                  {cert}
                </span>
              ))}
            </div>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 bg-slate-800 hover:bg-blue-600 border border-slate-700 hover:border-blue-600 text-slate-400 hover:text-white rounded-lg flex items-center justify-center transition-all duration-200"
                  aria-label={s.name}
                >
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
              <p className="text-blue-400 font-semibold text-xs uppercase tracking-wider mb-1">Hotline 24/7</p>
              <a href="tel:+84901234567" className="text-white font-black text-lg hover:text-blue-300 transition-colors">
                +84 90 123 4567
              </a>
            </div>
          </div>
