    ...
    return (
      <div className="pt-28 pb-20 bg-white dark:bg-slate-900 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Bài viết không tồn tại</h1>
          <p className="text-gray-500 dark:text-slate-400 mb-8">Bài viết bạn tìm kiếm không tồn tại hoặc đã bị xóa.</p>
          <Link
            to="/news"
    ...
    <div className="bg-white dark:bg-slate-900 min-h-screen pt-24 pb-16">
      <div className="max-w-4xl px-4 sm:px-8 lg:px-16">
        ...
        <div className="flex items-center gap-4 mb-4">
          <span className="text-gray-500 dark:text-slate-400 text-sm flex items-center gap-1.5">
        ...
        {article.category?.name && (
          <span className="inline-block bg-orange-50 dark:bg-orange-900/20 text-orange-600 text-xs font-bold px-3 py-1.5 rounded-full border border-orange-200 mb-5">
            {article.category.name}
          </span>
        )}

        {/* Title */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 dark:text-white mb-8 leading-tight">
          {article.title}
        </h1>
        ...
        <div
          className="prose prose-gray dark:prose-invert max-w-none
            ...
            prose-p:text-gray-700 dark:text-slate-300 prose-p:leading-relaxed prose-p:text-base
            prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline
            prose-img:rounded-xl prose-img:border prose-img:border-gray-200 dark:border-slate-700 prose-img:my-6
            prose-strong:text-gray-900 dark:text-white
            prose-ul:text-gray-700 dark:text-slate-300 prose-ol:text-gray-700 dark:text-slate-300
            prose-blockquote:border-orange-500 prose-blockquote:text-gray-500 dark:text-slate-400
              ...
              {relatedPosts.map((post) => (
                ...
                >
                  ...
                  <div className="flex flex-col justify-center min-w-0">
                    ...
                    <h4 className="text-gray-900 dark:text-white text-sm font-semibold group-hover:text-orange-500 transition-colors line-clamp-2">
                      {post.title}
                    </h4>
                  </div>
                </Link>
