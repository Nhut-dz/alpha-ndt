            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
              ...
              <div className="flex flex-wrap gap-2">
                {detail.standards.map((std, i) => (
                  <span
                    key={i}
                    className="bg-orange-500/10 text-orange-400 text-xs px-3 py-1.5 rounded-lg font-medium border border-orange-500/20"
                  >
                    {std}
                  </span>
                ))}
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
              ...
              <div className="flex flex-wrap gap-2">
                {detail.industries.map((ind, i) => (
                  <span
                    key={i}
                    className="bg-blue-500/10 text-blue-400 text-xs px-3 py-1.5 rounded-lg font-medium border border-blue-500/20"
                  >
                    {ind}
                  </span>
                ))}
